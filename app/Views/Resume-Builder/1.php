                ...
                <div class="col-md-12">
                    <div id="resume" class="container my-resume-page">
                        <div id="resume-page-1" class="row">
                            <div class="col-md-12">
                                <table class="main my-side-line"style="width:100%;background-color:black;color:white;border-radius:5px;">
                                            ...
                                            <p>
                                                ...
                                                <span class="w-40 text-right"><b>DOB:</b>
                                                    <span id="dob" contenteditable="true" spellcheck="true"
                                                        class="input-field head-field" onclick="selectAll()"></span>
                                                </span>
                                            </p>
                                            <p>
                                                <b>Address:</b>
                                ...
                                <table id="education-table" class="w-100 section my-side-line">
                                    <tr>
                                        <td style="width:100%;border-radius:5px;background-color:black;color:white"colspan="4" class="section-header">
                                            <h3>EDUCATION</h3>
                                        </td>
                                    </tr>
                                ...
                                <table id="skills-table" class="w-100 section my-side-line">
                                    <tr>
                                        <td style="width:100%;border-radius:5px;background-color:black;color:white"colspan="2" class="section-header">
                                            <h3>SKILLS</h3>
                                        </td>
                                    </tr>
                                ...
                                <table id="internships-table" class="w-100 section my-side-line">
                                    <tr>
                                        <td style="width:100%;border-radius:5px;background-color:black;color:white"colspan="3" class="section-header">
                                                ...
                                                <table class="w-100 section" id="awards-table">
                                                    <tr>
                                                        <td colspan="2" class="section-header">
                                                            <h3 style="width:100%;border-radius:5px;background-color:black;color:white">AWARDS AND ACHIEVEMENTS
