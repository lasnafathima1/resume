...
<?php endif;?>
    ...
    <main class="my-main my-resume-bg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div style=" background-image: url('<?=base_url()?>/new2/img/backk4.png');background-repeat: no-repeat;background-size:100% 100%;color:black;
border-radius:5px;border-width: 20px;"id="resume" class="container my-resume-page" style="padding:5%">
                        <div class ="flex">
                            <div id="col1"  class="vl" >
                        <div id="resume-page-1" class="row">
                            <div class="col-md-12">
                               <table id="internships-table" class="w-100 section">
                                    <tr>
                                        <td style="" colspan="3" class="section-header">
                                ...
                                <table id="awards-table" class="w-100 section">
                                    <tr>
                                        <td style="color:black;"colspan="2" class="section-header">
                        ...
                        <div id="col2">
                            ...
                            <table class="main">
                                ...
                                <table id="skills-table" class="w-100 section">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <button  contenteditable="true"  id="add-skill" class="addButton" onclick="addSkills()">Add Skills</button>
