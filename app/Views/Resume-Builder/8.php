...
<?php endif;?>
    ...
    <main class="my-main my-resume-bg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div style=" background-image: url('<?=base_url()?>/new2/img/backk8.png');background-repeat: no-repeat;background-size:100% 100%;color:white;
border-radius:5px;border-width: 20px;"id="resume" class="container my-resume-page" style="padding:5%">
                            ...
                            <div class="col-md-12">
                                <table class="main">
                                    <tr>
                                        ...
                                        <td class="intro w-70">
                                            <h1 style="color:white"id="stud-name" class="input-field head-field" contenteditable="true"
                                                spellcheck="true" onclick="selectAll()">Enter Full Name</h1>
                                           
                                            <p>
                                                <span class="w-60 inline-block">
                                                    <span  ><b style="color:white" >Email:</b></span>
                                                    <span id="e-mail" class="input-field head-field"
                                                        contenteditable="true" spellcheck="true"
                                                        onclick="selectAll()"></span>
                                                </span>
                                                <span class="w-40 text-right"><b style="color:white" >DOB:</b>
                                ...
                                <table id="education-table" class="w-100 section">
                                    <tr>
                                        <td style=""colspan="4" class="section-header">
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right" style="color:white" >
                                ...
                                <table id="skills-table" class="w-100 section">
                                    <tr>
                                        <td style="color:white" colspan="2" class="section-header">
                                            <h3>SKILLS</h3>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <button  style="color:white"  contenteditable="true"  id="add-skill" class="addButton" onclick="addSkills()">Add Skills</button>
                                            <button  style="color:white"    id="remove-skill" class="removeButton invisible"
                                ...
                                <table id="internships-table" class="w-100 section">
                                    <tr>
                                        <td style="color:white" colspan="3" class="section-header">
                                            <h3>PROFESSIONAL EXPERIENCE/INTERNSHIPS</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  style="color:white"  valign="top" class="w-20 input-field" contenteditable="true"
                                            spellcheck="true" onclick="selectAll()">
                                            <b>Name of Organization</b>
                                        </td>
                                        <td valign="top" class="w-60">
                                            <p style="color:white"  contenteditable="true" spellcheck="true" class="input-field"
                                                onclick="selectAll()">
                                                <b>Description</b>
                                            </p>
                                        ...
                                        <td  style="color:white"  valign="top" class="w-20 text-right input-field" contenteditable="true"
                                            spellcheck="true" onclick="selectAll()">
                                            <p><b>Duration</b></p>
                                    ...
                                    <tr>
                                        <td  style="color:white"  colspan="3" class="text-right">
                        ...
                        <div id="resume-page-2" class="row">
                            <div class="col-md-12">
                                <table id="projects-table" class="w-100 section">
                                    <tr>
                                        <td style="color:white"  style="" colspan="2" class="section-header">
                                            <h3>PROJECTS</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color:white"  valign="top" class="w-25">
                                        ...
                                        <td  style="color:white" valign="top" class="w-50 input-field" contenteditable="true"
                                            spellcheck="true" onclick="selectAll()">
                                            <p style="color:white" >
                                               <b> Description</b>
                                            </p>
                                        </td>
                                        <td  style="color:white"  valign="top" class="w-25 text-right input-field" contenteditable="true"
                                            spellcheck="true" onclick="selectAll()">
                                            <p><b>Duration</b></p>
                                ...
                                <hr>
                                <table class="w-100 section" style="color:white"  >
                                    <tr>
                                        <td style="" colspan="2" class="section-header">
                                ...
                                <!---->
                                <hr>
                                <button style="color:white"   id="ach-btn" class="addButton invisible"
                                    onclick="addAchievements()">Achievements</button>
                                <table id="awards-table" class="w-100 section" style="color:white" >
                                    <tr>
