...
<?php endif;?>
    ...
    <main class="my-main my-resume-bg relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12"style="background-color:#000">
                    <div id="resume" class="container my-resume-page"style="background-color:#02ebff">
                        <div id="resume-page-1" class="row"style="background-color:#02ebff">
                            <div class="col-md-12"style="background-color:#02ebff">
                                <table class="main my-side-line"style="background-color:#fff;width:100%;">
                                ...
                                <table id="education-table" class="w-100 section my-side-line">
                                    ...
                                    <tr>
                                        ...
                                        <td id="grad-year" contenteditable="true" spellcheck="true" class="input-field"
                                            onclick="selectAll()">2020</td>
                                        <td id="cpi" class="text-center input-field" contenteditable="true"
                                            spellcheck="true" onclick="selectAll()">xx.xx</td>
                                    </tr>
                                    <tr>
                                        <td id="class12" contenteditable="true" spellcheck="true" class="input-field"
                                            onclick="selectAll()">
                                    ...
                                    <tr>
                                        <td id="class10" contenteditable="true" spellcheck="true" class="input-field"
                                            onclick="selectAll()">
                                ...
                                <table style="background-color:#fff;width:100%;" id="skills-table" class="w-100 section my-side-line">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tools" class="w-70 input-field" contenteditable="true" spellcheck="true"
                                            onclick="selectAll()">Android Studio etc..</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" class="w-60">
                                            <p contenteditable="true" spellcheck="true" class="input-field"
                                                onclick="selectAll()">
                                                Describe here. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                Quisque
                                                pulvinar
                                                nibh
                                                in
                                                scelerisque bibendum. Phasellus ipsum ipsum, cursus nec sem sit amet.
                                            </p>
                                            <p contenteditable="true" spellcheck="true" class="input-field"
                        ...
                        <div id="resume-page-2" class="row">
                            <div class="col-md-12">
                                <table style="background-color:#fff;width:100%;" id="projects-table" class="w-100 section my-side-line">
                                    <tr>
                                        <td colspan="2" class="section-header">
                                            <h3>PROJECTS</h3>
                                        </td>
    ...
    <script src="<?= base_url(); ?>/new2/createPDF.js"></script>
    ...
    <script>
        ...
        var domainurl = "http://shivang2joshi.github.io/Resume-Builder/sharedpreview.html";
