...
<?php endif;?>
    ...
    <main class="my-main my-resume-bg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div id="resume" class="container my-resume-page" style="padding:5%">
                        <div id="resume-page-1" class="row">
                            <div class="col-md-12">
                                <table class="main">
                                    <tr>
                                        <td id="logo" class="w-30"><img src="<?= base_url(); ?>/new2/img/daiictlogo.jpg"></td>
                                        <td class="intro w-70">
                                            ...
                                            <p>
                                                ...
                                                <span class="w-40 text-right"><b>DOB:</b>
                                                    <span id="dob" class="input-field head-field" contenteditable="true"
                                                        spellcheck="true" onclick="selectAll()"> February 27,
                                                        1998</span>
                                                </span>
                                            </p>
                                            <p>
                                                ...
                                                <span id="address" contenteditable="true" class="input-field head-field"
                                                    spellcheck="true" onclick="selectAll()">F-313, HOR-MEN, DAIICT,
                                                    Gandhinagar</span>
                                            </p>
                                        </td>
                                    </tr>
